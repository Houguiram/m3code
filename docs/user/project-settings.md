...
For projects hosted on GitHub.com, M3 Code can use Graphite as the default place to open and copy
pull request links:
...
M3 Code checks in the background and when the server starts. It uses the branch's configured
