...
import { ModelSelection, ProjectGraphiteConfig, ProjectScript } from "@t3tools/contracts";
...
const ProjectionProjectDbRow = ProjectionProject.mapFields(
  Struct.assign({
    ...
    graphite: Schema.NullOr(Schema.fromJsonString(ProjectGraphiteConfig)),
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.graphite !== null && row.graphite !== undefined ? JSON.stringify(row.graphite) : null},
        ...
        DO UPDATE SET
          ...
          graphite_json = excluded.graphite_json,
