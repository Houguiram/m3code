...
/**
 * The palette M3 Code wears with no theme installed, captured from the app's
...
/**
 * The standard M3 Code look as a theme palette, for seeding a new theme when
...
/**
 * The status colors M3 Code shows without a theme, read from the app's own
