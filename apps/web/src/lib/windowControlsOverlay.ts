import { MACOS_VIBRANCY_CLASS_NAME } from "./macosVibrancy";
...
export function getElectronPlatformClassNames(
  ...
  | readonly [typeof ELECTRON_CLASS_NAME, typeof MACOS_VIBRANCY_CLASS_NAME] {
  if (isWindowsPlatform(platform)) {
    return [ELECTRON_CLASS_NAME, ELECTRON_WINDOWS_CLASS_NAME];
  }
  if (isMacPlatform(platform)) {
    return [ELECTRON_CLASS_NAME, MACOS_VIBRANCY_CLASS_NAME];
  }
