...
function getGnomeKeyringRemediationMessage(): string {
  return "M3 Code could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart M3 Code.";
}

function getKWalletRemediationMessage(): string {
  return "M3 Code could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart M3 Code.";
}
