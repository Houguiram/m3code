...
export const SET_KEEP_AWAKE_DISPLAY_CHANNEL = "desktop:set-keep-awake-display";
...
export const RESOLVE_M3_CODE_CHECKOUT_CHANNEL = "desktop:resolve-m3-code-checkout";
export const OPEN_M3_CODE_LOGIN_TERMINAL_CHANNEL = "desktop:open-m3-code-login-terminal";
