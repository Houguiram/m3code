...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "m3code-dev" : "m3code",
    legacyUserDataDirName: isDevelopment ? "M3 Code (Dev)" : "M3 Code (Alpha)",
...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "m3code-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, ["setPath:userData:/tmp/app-data/m3code-dev", "createClerkBridge"]);
  ...
  it.each([
    { isDevelopment: true, scheme: "m3code-dev" },
    { isDevelopment: false, scheme: "m3code" },
